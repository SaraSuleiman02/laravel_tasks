            ...
            <div>
                ...
                <div class="nav_list">
                    <a href="{{ route('dashboard.users') }}"
                        class="nav_link {{ request()->routeIs('dashboard.users') ? 'active' : '' }}"> <i
                            class='bx bx-user nav_icon'></i>
                        <span class="nav_name">Users</span>
                    </a>
                    <a href="{{ route('dashboard.task') }}"
                        class="nav_link {{ request()->routeIs('dashboard.task') ? 'active' : '' }}"> <i
                            class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Tasks</span>
                    </a>
                    <a href="{{ route('dashboard.tag') }}"
                        class="nav_link {{ request()->routeIs('dashboard.tag') ? 'active' : '' }}"> <i
