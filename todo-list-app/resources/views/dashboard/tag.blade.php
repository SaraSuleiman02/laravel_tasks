        ...
        <div class="table-wrapper">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center">No tags available. Add one above!</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".add", function() {
                ...
                $.post("{{ route('tags.store') }}", data, function(response) {
                    Swal.fire(
                        "Added!",
            ...
            $(document).on("click", ".save", function() {
                ...
                $.ajax({
                    url: "{{ route('tags.update', ':id') }}".replace(':id', userId),
                    method: 'PUT',
                    data: data,
            ...
            $(document).on("click", ".delete", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('tags.destroy', ':id') }}".replace(':id',
                                userId),
                            method: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
